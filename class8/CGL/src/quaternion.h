...
public:
     ...
     */
    Vector3D rotatedVector(const Vector3D &v) const { return (((*this) * Quaternion(v, 0)) * conjugate()).complex(); }
    ...
    static Quaternion slerp(const Quaternion &q0, const Quaternion &q1, double t) {
        ...
        return Quaternion(
                q0.x * st0 + q1.x * st1, q0.y * st0 + q1.y * st1, q0.z * st0 + q1.z * st1, q0.w * st0 + q1.w * st1);
    }
};
